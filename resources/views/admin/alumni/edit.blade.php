                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Edit Alumni</h6>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                ...
                                <form action="{{ route('admin.alumni.update', $alumni->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($alumni->foto)
                                            <img src="{{ asset('storage/alumni/' . $alumni->foto) }}" alt="{{ $alumni->nama }}" width="100">
                                        @endif
                                    </div>

                                    <div class="form-group">
                                        <label for="apa_kata">Apa Kata Alumni:</label>
                                        <textarea class="form-control" id="apa_kata" name="apa_kata" rows="3">{{ $alumni->apa_kata }}</textarea>
                                    </div>

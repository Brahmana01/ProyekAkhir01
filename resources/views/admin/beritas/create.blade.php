                            ...
                            <div class="container">
                                ...
                                <form action="{{ route('admin.beritas.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="topik" name="topik" value="{{ old('topik') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi_singkat">Deskripsi Singkat:</label>
                                        <textarea class="form-control" id="deskripsi_singkat" name="deskripsi_singkat" rows="3" required>{{ old('deskripsi_singkat') }}</textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_update" name="tanggal_update" value="{{ old('tanggal_update') }}">
                                    </div>

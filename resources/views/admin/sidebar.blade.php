<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
              <a class="nav-link text-dark" href="{{route('admin.galleries.index')}}">
          ...
          <!-- Tambahkan ini -->
          <li class="nav-item">
              <a class="nav-link text-dark" href="{{route('admin.videos.index')}}">
          ...
          <!-- Prestasi Menu -->
          <li class="nav-item">
              <a class="nav-link text-dark" href="{{ route('admin.prestasies.index') }}">

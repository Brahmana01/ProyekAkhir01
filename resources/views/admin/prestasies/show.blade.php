...
<head>
    @include('admin.head')
    <title>Admin - Detail Prestasi</title>
</head>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Detail Prestasi</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="container">
                                ...
                                <p>
                                    <strong>Foto:</strong>
                                    @if($prestasi->foto)
                                        <img src="{{ asset('storage/prestasi/' . $prestasi->foto) }}" alt="{{ $prestasi->judul }}" width="200">
                                    @else
                                        Tidak ada foto
                                    @endif
                                </p>

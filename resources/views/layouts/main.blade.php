...
<head>
    ...
    <style>
        ...
        @media (min-width: 768px) {
            ...
            .hide-on-mobile {
                display: block;
                /* Tampilkan di tablet dan desktop */
            }
            ...
            .header-top-contact ul li a {
                font-size: 14px;
                /* Ukuran font yang lebih besar untuk layar yang lebih besar */
            }
        }
    </style>
                ...
                <div class="header-top-wrap">
                    <div class="header-top-left">
                        <div class="header-top-social">
                            ...
                            <a
                                href="https://www.instagram.com/d3tidel_2024?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container position-relative">
                    <a class="navbar-brand" href="index">
                        <img src="http://www.del.ac.id/wp-content/uploads/2015/06/logox.png"
                            alt="D3 Teknologi Informasi">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Profil
                                    Prodi</a>
                                    ...
                                    <div class="container-fluid">
                                        <ul class="dropdown-menu fade-down">
                                            ...
                                            <li class="dropdown-submenu">
                                                <a class="dropdown-item dropdown-toggle" href="">Struktur
                                                    organisasi</a>
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="strukturorganisasi1">
                                                            Struktur Wakil Rektor<br> Bidang akademik dan<br>
                                                            Kemahasiswaan </a></li>
                                                    <li><a class="dropdown-item" href="strukturorganisasi2">
                                                            Struktur Wakil Rektor<br> Bidang Perencanaan<br>Keuangan dan
                                                            Sumber<br>Daya</a></li>
                                                    <li><a class="dropdown-item" href="strukturorganisasi3">
                                                            Struktur Wakil Rektor<br> Bidang Kemitraan<br>Inovasi dan
                                                            <br>Kewirausahaan</a></li>
                                                </ul>
                                            </li>
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{route ('lecturers')}}">Lecturers</a></li>

                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#"
                                    data-bs-toggle="dropdown">Dokumentasi</a>
                                <ul class="dropdown-menu fade-down">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#"
                                    data-bs-toggle="dropdown">HubConnect</a>
                                <ul class="dropdown-menu fade-down">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{route ('kemitraan')}}">Kerjasama</a></li>
                        </ul>
                    </div>
                </div>
            </nav>

            ...
            <div class="row footer-widget-wrapper pt-100 pb-70">
                <div class="col-md-6 col-lg-4">
                    <div class="footer-widget-box about-us">
                        ...
                        <p class="mb-3">
                            Beberapa informasi mungkin telah mengalami penyesuaian untuk keperluan penyampaian yang menarik,
                                namun tetap mengutamakan keakuratan dan kredibilitas
                        </p>
                        <ul class="footer-contact">
                            <li><a href="tel:+620632331234"><i class="far fa-phone"></i>0632-331234</a></li>
                            <li><i class="far fa-map-marker-alt"></i>Sitoluama,Laguboti,Toba</li>
                            <li><a href="mailto:info@example.com"><i
                                        class="far fa-envelope"></i>diploma3tiDel@gmail.com</a></li>
                        </ul>
                    </div>
                </div>

                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tambah Pengumuman</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="container">
                                ...
                                <form action="{{ route('admin.pengumuman.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="topik">Gambar:</label>
                                        <input type="file" class="form-control-file" id="gambar" name="gambar">
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal_update_pengumuman">Tanggal Update:</label>
                                        <input type="date" class="form-control" id="tanggal_update_pengumuman" name="tanggal_update_pengumuman" value="{{ old('tanggal_update_pengumuman') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan_lengkap_pengumuman">Keterangan:</label>
                                        <textarea class="form-control" id="keterangan_lengkap_pengumuman" name="keterangan_lengkap_pengumuman" rows="5">{{ old('keterangan_lengkap_pengumuman') }}</textarea>
                                    </div>
